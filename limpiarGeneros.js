...
const mapaDeGeneros = {
  ...
  // Estandarizar capitalización (se hará automáticamente, pero podemos forzarlo)
  'rock': 'Rock',
  'pop': 'Pop',
  'hard rock': 'Hard Rock',
  'shoegaze': 'Shoegaze',
...
function limpiarYCapitalizar(genero) {
    ...
    // 1. Si es un número (como "1987"), lo descartamos.
    if (!isNaN(generoEnMinusculas)) {
    ...
    // 3. Si no hay regla, simplemente lo capitalizamos correctamente.
...
try {
    ...
    const productosLimpios = productos.map(producto => {
        ...
        // lo dejamos como 'Rock' por defecto.
        ...
        // Devolvemos el producto con el género actualizado
